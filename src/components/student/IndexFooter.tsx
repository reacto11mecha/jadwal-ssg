      ...
      <div className="flex flex-wrap h-full items-center justify-center">
        <div className="flex text-xl gap-5 p-3">
          <a
            ...
            className="border-zinc-300 py-2 px-3 text-lg dark:bg-zinc-900 dark:border-sm dark:border-zinc-900 bg-gray-50 border rounded-md flex justify-center items-center"
          >
            <BsGithub />
          </a>
          <a
